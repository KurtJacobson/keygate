...
const TEMPLATE_META: Record<string, { label: string; variables: string[] }> = {
  ...
  support_expiring: { label: "Support Ending Soon", variables: ["Product", "LicenseKey", "EndsAt"] },
  support_ended: { label: "Support Ended", variables: ["Product", "LicenseKey"] },
  support_renewed: { label: "Support Renewed", variables: ["Product", "RenewedUntil"] },
