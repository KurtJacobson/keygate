const zh = {
  ...
  "login.totpPrompt": "请输入身份验证器应用中的 6 位验证码",
  "login.startOver": "重新开始",
  ...
  "portal.twoFactor": "两步验证",
  "portal.twoFactorEnabled": "已启用",
  "portal.twoFactorDisabled": "未启用",
  "portal.twoFactorDesc": "登录时除邮箱验证码外，还需输入身份验证器应用（Google Authenticator、1Password、Bitwarden 等）生成的验证码。",
  "portal.twoFactorEnableBtn": "启用两步验证",
  "portal.twoFactorDisableBtn": "关闭两步验证",
  "portal.twoFactorSetupHint": "将此密钥添加到身份验证器应用（选择「手动输入密钥」）：",
  "portal.twoFactorSecret": "设置密钥",
  "portal.twoFactorOpenApp": "或直接在身份验证器应用中打开",
  "portal.twoFactorConfirmHint": "然后输入当前验证码以确认：",
  "portal.twoFactorActivateBtn": "确认并启用",
  "portal.twoFactorDisableHint": "输入当前验证码以关闭两步验证：",
