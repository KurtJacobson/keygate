const zh = {
  ...
  "plans.supportDays": "支持天数",
  "plans.supportDaysHint": "新许可证的默认付费支持/更新窗口（天数）。0 表示无限期。",
  ...
  "licenses.offlineToken": "离线许可证",
  "licenses.offlineTitle": "签发离线许可证",
  "licenses.offlineDesc": "为永不联网的隔离设备生成绑定机器的许可证文件。",
  "licenses.offlineMachineCode": "机器码",
  "licenses.offlineMachineCodeHint": "设备的机器码，从应用中读取。许可证文件与其绑定，无法在其他机器上使用。",
  "licenses.offlineExpiryOptional": "有效期（可选）",
  "licenses.offlineExpiryHint": "留空表示永久许可证文件。设置日期则需在续期时重新签发。",
  "licenses.offlineGenerate": "生成许可证文件",
  "licenses.offlineResult": "许可证文件",
  "licenses.offlineResultHint": "将此文件发送给客户，安装到隔离机器上。",
  ...
  "login.codeSentTo": "如果 {email} 已注册，登录验证码已发送至该邮箱。",
  "login.noAccountHint": "没有收到验证码？您的邮箱可能不在系统中——请联系支持申请账户。",
  "login.verify": "验证",
  "login.verifying": "验证中...",
  ...
  "portal.offlineActivate": "激活离线设备",
  "portal.offlineAdminOnly": "如需更换机器请联系支持",
  "portal.offlineDesc": "为永不联网的机器生成许可证文件。你可以激活一台离线机器；如需更换请联系支持。",
  "portal.offlineMachineCode": "机器码",
  "portal.offlineMachineCodeHint": "离线设备上应用中显示的机器码。",
  "portal.offlineLabelOptional": "标签（可选）",
  "portal.offlineGenerate": "生成许可证文件",
  "portal.offlineFingerprint": "指纹",
  "portal.offlineFile": "许可证文件",
  "portal.offlineFileHint": "保存此文件并安装到离线机器上。",
  "portal.offlineDownload": "下载 .lic",
