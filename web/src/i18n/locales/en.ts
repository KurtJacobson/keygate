const en = {
  ...
  "plans.supportDays": "Support Days",
  "plans.supportDaysHint": "Default paid support/updates window for new licenses, in days. 0 = unlimited.",
  ...
  "licenses.supportUntil": "Support Until",
  "licenses.supportUnlimited": "Unlimited",
  "licenses.supportUntilOptional": "Support until (optional)",
  ...
  "login.codeSentTo": "If {email} is registered, a login code has been sent to it.",
  "login.noAccountHint":
    "Didn't receive a code? Your email may not be in the system — contact support to request an account.",
  "login.verify": "Verify",
  ...
  "portal.offlineActivate": "Activate offline device",
  "portal.offlineAdminOnly": "Contact support to switch machines",
  "portal.offlineDesc":
    "Generate a license file for a machine that never connects to the internet. You can activate one offline machine; contact support to switch to a different one.",
  "portal.offlineMachineCode": "Machine code",
  "portal.offlineMachineCodeHint": "The machine code shown in the app on the offline device.",
  "portal.offlineLabelOptional": "Label (optional)",
  "portal.offlineGenerate": "Generate license file",
  "portal.offlineFingerprint": "Fingerprint",
  "portal.offlineFile": "License file",
  "portal.offlineFileHint": "Save this file and install it on the offline machine.",
  "portal.offlineDownload": "Download .lic",
  ...
  "plans.quotaLimit": "Limit",
  "plans.quotaLimitHint": "0 = unlimited",
