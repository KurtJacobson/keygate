const en = {
  ...
  "portal.twoFactor": "Two-factor authentication",
  "portal.twoFactorEnabled": "Enabled",
  "portal.twoFactorDisabled": "Off",
  "portal.twoFactorDesc":
    "Require a code from an authenticator app (Google Authenticator, 1Password, Bitwarden, ...) in addition to your email code when signing in.",
  "portal.twoFactorEnableBtn": "Enable two-factor auth",
  "portal.twoFactorDisableBtn": "Disable two-factor auth",
  "portal.twoFactorSetupHint": "Add this key to your authenticator app (choose \"enter key manually\"):",
  "portal.twoFactorSecret": "Setup key",
  "portal.twoFactorOpenApp": "Or open directly in your authenticator app",
  "portal.twoFactorConfirmHint": "Then enter the current code to confirm:",
  "portal.twoFactorActivateBtn": "Confirm & enable",
  "portal.twoFactorDisableHint": "Enter a current authenticator code to turn off two-factor auth:",
